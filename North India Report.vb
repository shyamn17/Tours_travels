...
Public Class North_India_Report
    ...
    Private Sub PrintDocument1_PrintPage_1(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        xpos = 250
        e.Graphics.DrawString("NORTH INDIA REPORT DETAILS", MyFont, Brushes.Blue, xpos, ypos)
        ypos = 150
        If conn.State = ConnectionState.Open Then conn.Close()
        conn.Open()
        ...
        While d2.Read
            ...
            e.Graphics.DrawString("PassengerID", MyFont, Brushes.Black, xpos, ypos)
            xpos = xpos + 300
            ...
            ypos = ypos + 80
            xpos = 130
            e.Graphics.DrawString("EmailID", MyFont, Brushes.Black, xpos, ypos)
            xpos = xpos + 300
    ...
    Private Sub North_India_Report_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If conn.State = ConnectionState.Open Then conn.Close()
        conn.Open()
